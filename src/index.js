...
export const HANDS_LANDMARK_INDICE = {
    wrist: 0,
    thumb: [ 1, 2, 3, 4 ],
...
export const POSE_LANDMARK_COLORS = [
    [ 255, 255, 255 ], // nose
...
export const POSE_LANDMARK_INDICE = {
    nose: 0,
    left_eye_inner: 1,
    left_eye: 2,
    left_eye_outer: 3,
...
export async function createDetector(mode)
{
	let detector;
...
export async function estimate(model, image)
{
